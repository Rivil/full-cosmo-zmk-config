 ...
 *
 * Lightning-bolt glyph used to mark the charging battery. Taken verbatim from
 * app/boards/shields/nice_view/widgets/bolt.c (ZMK, v0.3.0); inverted-palette
 * branch dropped because our palette is fixed (white bg / black fg).
 */
